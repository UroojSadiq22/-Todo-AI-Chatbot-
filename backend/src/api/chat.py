...
async def chat_endpoint(
    ...
    try:
        ...
        # "content": (
        #         f"You are a task management assistant. The current user's ID is {user_id}. "
        #         "CRITICAL: When calling tools, you MUST use this exact ID for the 'user_id' parameter. "
        #         "Never use placeholders like '12345' or 'current_user'. "
